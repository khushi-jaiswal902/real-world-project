...
import { necklaceList } from '../assets/assets'
...
const JewelryCollection = () => {
    ...
    const jewelryItems = useMemo(() => necklaceList.slice(), [])
                        ...
                        >
                            ...
                            <div className='px-4 pb-4 flex flex-col'>
                                ...
                                <p className='mb-3 text-sm text-slate-500 line-clamp-2 min-h-[40px]'>
                                    {item.description || 'Elegant jewellery pick to elevate your look instantly.'}
                                </p>
