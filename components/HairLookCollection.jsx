...
import { hairLookList } from '../assets/assets'

const HairLookCollection = () => {
    const { currency, setSearch, setShowSearch, navigate, addToCart, toggleWishlist, isInWishlist } = useContext(ShopContext)

    const hairLookItems = useMemo(() => hairLookList.slice(), [])
                        ...
                        >
                            ...
                            <div className='px-4 pb-4 flex flex-col'>
                                ...
                                <p className='mb-3 text-sm text-slate-500 line-clamp-2 min-h-[40px]'>
                                    {item.description || 'Hair look essentials curated to elevate your everyday style.'}
                                </p>
...
export default HairLookCollection
